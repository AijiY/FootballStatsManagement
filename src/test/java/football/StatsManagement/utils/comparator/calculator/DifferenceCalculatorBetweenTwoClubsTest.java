...
class DifferenceCalculatorBetweenTwoClubsTest {
  ...
  private void setUpWhenHeadToHead(ClubForStanding c1, ClubForStanding c2, Club club1, Club club2) {
  ...
  private void tearDownWhenHeadToHead(ClubForStanding c1, ClubForStanding c2, Club club1, Club club2) {
  ...
  void pointsAgainstDifference() {
    ...
    setUpWhenHeadToHead(c1, c2, club1, club2);
    ...
    tearDownWhenHeadToHead(c1, c2, club1, club2);
  }
